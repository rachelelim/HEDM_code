...
Reads in filtered stress and strain data and makes a couple of histograms for
...
from hexrd import rotations as rot #in python3 from hexrd import rotations as rot
#%%
