"""
Makes IPF for hexagonal material with Y as the loading directions
Change line 115 to plot other directions
"""
...
from hexrd import symmetry as symm
...
gt = np.loadtxt(grains_file, ndmin=2)
...
plane_data = load_pdata(mat_file, mat)
